...
|Environments| are further isolated resource pools. Each |Environment| is connected to one or more cloud platforms. One or more teams can be granted access to each |Environment|. |Environments| can correspond to
